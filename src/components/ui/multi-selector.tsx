  ...
  (
    ...
    return (
      <Command
        ...
        className={cn('overflow-visible bg-transparent rounded-lg  shadow-md', commandProps?.className)}
        shouldFilter={
...
{option.img ? (
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                ' h-6 ml-2 flex-1 bg-transparent outline-none placeholder:text-muted-foreground',
